...
class HistoryList extends PureComponent {
    ...
    getHistoryList = (params) => {
        ...
        dispatch({
            type: 'messageBdList/fetchHistoryMessageList',
            payload: getParams
        });
    }
    ...
    getSysMessageUser = params => {
        ...
        dispatch({
            type: 'messageBdList/fetchHistoryDetailsList',
            payload: getParams
        });
    };
    ...
    render() {
        const {
            messageBdList: { historyData, historyDetailsData },
            loading,
        } = this.props;
