...
const CreateForm = Form.create()(props => {
  ...
  return (
    <Card type="inner" title={<span><Icon type="message" /> BD人员消息推送</span>}>
      ...
      <FormItem {...formLayout} label="柬文内容">
        ...
        >
          ...
          {menu.indexOf('historyPush') != -1 ? (
            <Link style={{ marginLeft: 8 }} to="/message/bd/history">
              <Button icon="menu">
...
@connect(({ messageBdList, common, loading }) => ({
  messageBdList,
  common,
  loading: loading.models.messageBdList,
}))
@Form.create()
class MessageList extends PureComponent {
  ...
  getList = params => {
    ...
    dispatch({
      type: 'messageBdList/fetchBdList',
      payload: getParams,
    });
  };
  ...
  handleSubmitMessage = (fields, form) => {
    ...
    dispatch({
      type: 'messageBdList/fetchMessageBdSend',
      payload: formData,
      callback: res => {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <div className="page_head">
          <span className="page_head_title">BD人员列表</span>
        </div>
