...
@connect(({ messageConsumerList, loading }) => ({
    messageConsumerList,
...
class HistoryList extends PureComponent {
    ...
    getHistoryList = (params) => {
        ...
        dispatch({
            type: 'messageConsumerList/fetchHistoryMessageList',
            payload: getParams
        });
    }
    ...
    getSysMessageUser = params => {
        ...
        dispatch({
            type: 'messageConsumerList/fetchHistoryDetailsList',
            payload: getParams
        });
    };
    ...
    render() {
        const {
            messageConsumerList: { historyData, historyDetailsData },
            loading,
        } = this.props;
