...
@connect(({ messageDriverList, loading }) => ({
    messageDriverList,
...
class HistoryList extends PureComponent {
    ...
    getHistoryList = (params) => {
        ...
        dispatch({
            type: 'messageDriverList/fetchHistoryMessageList',
            payload: getParams
        });
    }
    ...
    getSysMessageUser = params => {
        ...
        dispatch({
            type: 'messageDriverList/fetchHistoryDetailsList',
            payload: getParams
        });
    };
    ...
    render() {
        const {
            messageDriverList: { historyData, historyDetailsData },
            loading,
        } = this.props;
