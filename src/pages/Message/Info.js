...
class Info extends PureComponent {
  constructor(props) {
    ...
    const menuMap = {
      consumer: (
        <FormattedMessage id="menu.message.consumer" defaultMessage="consumer" />
      ),
      merchant: (
        <FormattedMessage id="menu.message.merchant" defaultMessage="merchant" />
      ),
      deliveryman: (
        <FormattedMessage id="menu.message.deliveryman" defaultMessage="deliveryman" />
      ),
    };
