...
@Form.create()
class PermissionEdit extends PureComponent {
  state = {
    formValues: {},
    is_menu: '0',
  };
  componentDidMount = () => {
    this.setState({
      is_menu: parseInt(this.props.location.query.isMenu),
    });
  };
  handleSubmit = e => {
    e.preventDefault();
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      // 提交数据
      dispatch({
        type: 'adminSetting/fetchPermissionEdit',
        payload: formData,
        callback: res => {
          console.log(res);
          if (res.code == 200) {
  ...
  render() {
    ...
    console.log(this.props.location.query.parentId);
    ...
    console.log(this.state.is_menu);
    return (
      <Fragment>
        <h3 className="edit_title">编辑模块</h3>
