...
import { getCountryInfo } from '@/services/business';
...
class CreateForm extends PureComponent {
  ...
  render() {
    ...
    return (
      ...
      >
        <Form>
          <FormItem {...formLayout} label="国家名称">
          ...
          <FormItem {...formLayout} label="英文国家名称">
            {form.getFieldDecorator('name_en', {
              rules: [{ required: true, message: '必填' }],
            })(<Input placeholder="请输入" />)}
          </FormItem>
          <FormItem {...formLayout} label="柬文国家名称">
...
class Country extends PureComponent {
  ...
  getList = (params) => {
    ...
    dispatch({
      type: 'business/fetchCountryList',
      payload: getParams
    });
  }
  ...
  columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Fragment>
          <Link to={'/business/city/' + record.id}>查看城市</Link>
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'business/fetchCountrySave',
      payload: formData,
      callback: (res) => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'business/fetchCountryEdit',
      payload: formData,
      callback: (res) => {
        if (!utils.successReturn(res)) return;
  ...
  handleDelete = fields => {
    ...
    confirm({
      ...
      onOk: () => {
        ...
        dispatch({
          type: 'business/fetchCountryDelete',
          payload: formData,
          callback: (res) => {
            if (!utils.successReturn(res)) return;
      ...
      <div>
        <Card bordered={false}>
          <div className="page_head">
            <div className="page_head_title">国家</div>
            <div className="fr">
              <Button type="primary" icon="plus" onClick={() => this.handleModalVisible(true)}>新增国家</Button>
            </div>
          </div>
