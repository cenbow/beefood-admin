...
@Form.create()
class MerchantComment extends Component {
    state = {
    ...
    getList = params => {
        ...
        dispatch({
            type: 'deliverymanComment/fetchMerchantComment',
            payload: getParams,
        });
    };
        ...
        return (
            <Form onSubmit={this.handleSearch} layout="inline">
                <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
                    <Col md={4} sm={24}>
                        <FormItem label="商家名称">
                            {getFieldDecorator('merchant_name')(<Input placeholder="" />)}
                        </FormItem>
                    </Col>
                    <Col xl={4} md={8} sm={24}>
                        <FormItem label="评价结果">
    ...
    render() {
        const { loading, deliverymanComment: { merchantCommentList = {} } } = this.props;
...
export default MerchantComment;
